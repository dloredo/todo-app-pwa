    ...
    <section class="space-y-6">
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600">
                ...
                eliminarán permanentemente. Antes de eliminar su cuenta,
        ...
        <Modal :show="confirmingUserDeletion" @close="closeModal">
            <div class="p-6">
                <h2 class="text-lg font-medium text-gray-900">
                    ¿Estás segur@ de que quieres eliminar tu cuenta?
                </h2>

                <p class="mt-1 text-sm text-gray-600">
                    Una vez que se elimina su cuenta, todos sus recursos y datos
                    será eliminado permanentemente. Por favor ingrese su
